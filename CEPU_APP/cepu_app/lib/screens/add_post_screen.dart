...
import 'package:cepu_app/model/post.dart';
...
class _AddPostScreenState extends State<AddPostScreen> {
  ...
  Future<void> _generateDescriptionWithAI() async {
    ...
    try {
      ...
      const url = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-3-flash-preview:generateContent?key=AIzaSyD8wa7M5uZD2Q4r75SVd-d-XcA89Ug_mZ4';
